...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-004-goldbach-s-conjecture-8e0e9a64-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-004"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-004-goldbach-s-conjecture-8e0e9a64-v1",
      "problem_contract_sha256": "d9f6ffa4ce32010d8b28fb5a5b2e24ff80e24d1cd22affe70478d269f636dda3",
      "problem_id": "problem:um-nt-004-goldbach-s-conjecture-8e0e9a64",
      "route_id": "route:um-nt-004-goldbach-s-conjecture-8e0e9a64-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-004-goldbach-s-conjecture-8e0e9a64-source-fidelity-01",
      "graph_id": "graph:um-nt-004-goldbach-s-conjecture-8e0e9a64-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-004-goldbach-s-conjecture-8e0e9a64-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-004-goldbach-s-conjecture-8e0e9a64-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Every even integer greater than 2 can be expressed as the sum of two primes."
          },
          "statement_sha256": "2e4378d602889d9787fb42fa205222ebab476d6df467b8f6c7484b5ef40f5108"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-004-goldbach-s-conjecture-8e0e9a64-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-004-goldbach-s-conjecture-8e0e9a64-root",
      "route_id": "route:um-nt-004-goldbach-s-conjecture-8e0e9a64-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-004-38d41da4d22f",
        "url": "https://www.unsolvedmath.com/problems/NT-004"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
